...
| `localize` | `swiftui-localization-auditor` | `Use the swiftui-project-router skill. localize this app and audit every supported language.` |
| `privacy-audit` | `apple-app-security-privacy-auditor` | `Use the swiftui-project-router skill. privacy-audit this Apple app for data-flow and credential risks.` |
