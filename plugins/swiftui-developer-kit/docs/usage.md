...
Use the swiftui-project-router skill. localize this app and audit every supported language.
Use the swiftui-project-router skill. privacy-audit this Apple app for data-flow and credential risks.
...
```text
Use the swiftui-localization-auditor skill. Audit String Catalogs, language switching, pluralization, locale formatting, RTL, and localized accessibility strings.
```

```text
Use the apple-app-security-privacy-auditor skill. Audit this app's Keychain, networking, authentication, deep links, storage, permissions, entitlements, SDKs, and disclosures.
```
