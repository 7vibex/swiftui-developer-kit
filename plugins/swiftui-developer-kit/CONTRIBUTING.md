...
Examples should be realistic but fictional. Prefer a mix of app domains (for example, study, finance, health, media, or travel) so guidance remains reusable; do not include private project details.
