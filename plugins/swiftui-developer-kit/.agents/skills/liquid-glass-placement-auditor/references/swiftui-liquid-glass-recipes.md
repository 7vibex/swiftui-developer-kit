...
6. If build/run is approved by the user or host project, build after code changes and exercise both the Liquid Glass path and fallback path; otherwise state the static verification completed and the approval still needed.
