...
- Do you explicitly approve the capture method: Simulator screenshot, Appshot, or Computer Use?
- Is Simulator open, and which exact screen/state should be captured?
- Is anything sensitive/private visible?
- Where should the capture and non-sensitive inventory be saved, and do you approve that inventory?

Do not capture until the user confirms every item in the shared capture consent protocol.
...
- See the fictional workflow example at `../../../examples/simulator-screenshot-review-example.md`.
