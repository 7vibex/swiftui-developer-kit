...
- If the user or host project approves build/run, use the required iPad simulator; otherwise report the static checks completed and the approval still needed.
