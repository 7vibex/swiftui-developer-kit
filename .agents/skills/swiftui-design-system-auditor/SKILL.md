...
4. Check visual system: hierarchy, spacing rhythm, typography, SF Symbols, color, contrast, empty states, and component consistency.
5. Check interaction quality: keyboard shortcuts, pointer affordances, Apple Pencil flows, focus order, hit targets, and repeated-use ergonomics.
6. Separate design-system findings from architecture, accessibility, Liquid Glass, or release-readiness findings.
7. Prioritize findings by user impact and implementation risk.
8. Give concrete SwiftUI-oriented fixes and verification steps.
