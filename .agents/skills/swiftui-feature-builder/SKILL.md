...
5. Implement small changes with clear verification checkpoints.
6. Add accessibility labels, traits, Dynamic Type behavior, and keyboard or pointer support where relevant.
7. Add focused tests when project structure supports them.
8. Verify build, tests, or static checks when safe.
9. Summarize changes, tests, verification, and follow-up improvements.
