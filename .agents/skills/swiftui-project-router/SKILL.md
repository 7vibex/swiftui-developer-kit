...
description: Route broad Apple app requests or named workflow commands like audit, canvas-audit, fix-build, diagnostics, review-screenshots, prepare-release, modernize-ui, improve-tests, draft-pr, and detect-risks.
---
